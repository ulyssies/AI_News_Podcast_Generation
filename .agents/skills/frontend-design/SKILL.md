...
**Read `~/Codex-shared/design-system.md` before writing a single line of UI code.**

Then check `AGENTS.md` for any project-specific overrides under the Design System section.
...
1. Read `~/Codex-shared/design-system.md`
2. Read `AGENTS.md` for project-specific overrides
